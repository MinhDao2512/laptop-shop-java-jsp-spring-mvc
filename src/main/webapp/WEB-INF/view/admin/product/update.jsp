                    ...
                    <div class="mt-5">
                        <div class="row">
                            <div class="col-md-6 col-12 mx-auto">
                                ...
                                <hr />
                                <form:form class="row" method="post" action="/admin/product/update" modelAttribute="newProduct" 
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <form:textarea type="document" class="form-control ${not empty errorDetailDesc ? 'is-invalid' : ''}" path="detailDesc"/>
                                        ${errorDetailDesc}
                                    </div>
                                    <div class="mb-3 col-12 col-md-6">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty newProduct.image}">
                                            <div class="mb-3 col-12">
                                                <img src="<c:url value = '/images/product/${newProduct.image}'/>" style="max-height: 250px; display: block;" alt="image preview" id="imagePreview"/>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="mb-3 col-12">
